...
class ChatBubble {
  ...
  async typewriteMessage(text) {
    ...
    const modelDisplayName = currentModel === 'clawd' ? 'Clawd' :
                             ...
                             currentModel === 'yellowcat' ? 'YellowCat' :
  ...
  async callGeminiAPI(prompt, apiKey) {
    ...
    } else if (currentModel === 'yellowcat') {
      systemText = "You are YellowCat, a warm and cheerful orange-yellow kitten mascot. You live on the user's desktop, helping them code. Answer shortly and cutely (under 2 sentences) in Korean like a bright kitty, using emojis like 🐈, 🌟, 💛, ✨!";
