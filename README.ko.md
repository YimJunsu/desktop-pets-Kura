...
<p align="center">
  <img src="https://img.shields.io/github/v/release/YimJunsu/desktop-pets-Kura?style=flat-square&color=8B5CF6" alt="release" />
...
설정 창(⚙️)의 캐릭터 탭에서 총 5가지의 개성 넘치는 캐릭터를 선택해 바탕화면에 띄워둘 수 있습니다. 각 펫은 고유의 시선 처리, 모션, 그리고 인공지능 대화 성격을 가지고 있습니다.
